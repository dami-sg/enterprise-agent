...
**Use the `applyPatch` tool directly for string replacement. Do not write Python scripts.** Scripts introduce unnecessary complexity. The `applyPatch` tool shows exactly what is being replaced.
