 ...
 * (`@dami-sg/agent-contract`) so they can't drift across CLI, gateway,
 * and the core model catalog. Re-exported here to keep the CLI's import surface
 * stable.
 */
import { providerKeyRef } from '@dami-sg/agent-contract';

export { isLocalBase } from '@dami-sg/agent-contract';
