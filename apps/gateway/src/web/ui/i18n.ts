...
var I18N = {
  zh: {
    ...
    fullHint: 'full 模式：跳过分类器，仅拦高危（删除/提权/远程执行/开监听/脚本），其余不再审批',
  ...
  en: {
    ...
    fullHint: 'full mode: skip the classifier; only high-risk ops (deletion / escalation / remote exec / listeners / scripts) are gated, the rest run unprompted',
